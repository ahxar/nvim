...
-- Comprehensive language server setup with multiple languages and formatters
-- ══════════════════════════════════════════════════════════════════════════════
...
return {
	...
	config = function()
		-- Import utilities for better error handling
		local utils = require("ahxar.utils")

		-- Safely require blink-cmp capabilities
		local capabilities = {}
